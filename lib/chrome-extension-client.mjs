...
const GRANTLESS_METHODS = new Set(["status", "workspace.status", "workspace.init", "workspace.release", "chatgpt.extensionStatus"]);

function normalizeBackgroundChromeMethod(method) {
  // Compatibility for stale/older callers. There must be exactly one tab-open
  // path: the managed MDB workspace. Raw tabs.open used to create loose tabs.
